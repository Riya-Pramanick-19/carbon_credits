    ...
    >
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-3">
        ...
        <div className="flex items-center gap-3">
          <div className="relative flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-[#10b981] to-[#059669] shadow-[0_0_20px_rgba(16,185,129,0.3)]">
        ...
        <div className="flex items-center gap-3">
          ...
          {walletAddress ? (
            ...
            <button
              ...
              className="relative overflow-hidden rounded-xl bg-gradient-to-r from-[#10b981] to-[#059669] p-[1px] transition-all hover:shadow-[0_0_25px_rgba(16,185,129,0.25)] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
            >
